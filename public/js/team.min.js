    ...
    $(document).ready(function($) {
        ...
        function() {
            var options = {
                ...
                labelList = ["Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb"],
                series1List = {
                    name: "series-1",
        ...
        function() {
            ...
            $("#addNewItemBtn").on("click", function() {
                ...
                handleSelective(handleSelectiveItem), $("#addtodoItemForm").modal("show")
            }), $(".list-group-item").on("click", function() {
                var oldTitle = $(this).find(".item-title").text(),
                    dueDate = $(this).find("span").text();
                dueDate = "No due date" == dueDate ? null : "10/1/2015", $("#editTitle").val(oldTitle), $("#editDueDate").val(dueDate);
                var handleSelectiveItem = [];
                handleSelective(handleSelectiveItem), $("#edittodoItemForm").modal("show")
            })
        }()
