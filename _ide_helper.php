 ...
 * Generated for Laravel 5.2.32 on 2016-06-23.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \VkStroll\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \VkStroll\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \VkStroll\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \VkStroll\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \VkStroll\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \VkStroll\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \VkStroll\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \VkStroll\Console\Kernel::bootstrap();
        }
    ...
    class cURL extends \anlutro\cURL\Laravel\cURL{
        ...
        public static function getAllowedMethods(){
            return \anlutro\cURL\cURL::getAllowedMethods();
        }
        ...
        public static function setRequestClass($class){
            return \anlutro\cURL\cURL::setRequestClass($class);
        }
        ...
        public static function setResponseClass($class){
            return \anlutro\cURL\cURL::setResponseClass($class);
        }
        ...
        public static function setDefaultHeaders($headers){
            return \anlutro\cURL\cURL::setDefaultHeaders($headers);
        }
        ...
        public static function getDefaultHeaders(){
            return \anlutro\cURL\cURL::getDefaultHeaders();
        }
        ...
        public static function setDefaultOptions($options){
            return \anlutro\cURL\cURL::setDefaultOptions($options);
        }
        ...
        public static function getDefaultOptions(){
            return \anlutro\cURL\cURL::getDefaultOptions();
        }
        ...
        public static function buildUrl($url, $query){
            return \anlutro\cURL\cURL::buildUrl($url, $query);
        }
        ...
        public static function newRequest($method, $url, $data = array(), $encoding = 0){
            return \anlutro\cURL\cURL::newRequest($method, $url, $data, $encoding);
        }
        ...
        public static function newJsonRequest($method, $url, $data = array()){
            return \anlutro\cURL\cURL::newJsonRequest($method, $url, $data);
        }
        ...
        public static function newRawRequest($method, $url, $data = ''){
            return \anlutro\cURL\cURL::newRawRequest($method, $url, $data);
        }
        ...
        public static function prepareRequest($request){
            \anlutro\cURL\cURL::prepareRequest($request);
        }
        ...
        public static function sendRequest($request){
            return \anlutro\cURL\cURL::sendRequest($request);
        }
