...
<head>
    ...
    <title>Авторизация | Remark Admin Template</title>
...
<div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
    ...
    <div class="page-content vertical-align-middle">
        ...
        <p class="error-advise">Попробуйте перейти на главную страницу</p>
        <a class="btn btn-primary btn-round" href="../index.html">Вернуться на главную</a>
